                ...
                case "criar-gerente":
                    {
                        ...
                        $login = LoginController::getSingleton();
                        $response = $login->criarCredenciais($_POST["nome"], $_POST["senha"]);
                        if ($response["status"])
                                ...
                                <div class='col'>
                                    <div class='collapse' id='alterar-gerente'>
                                        <div class='container alert alert-warning border-warning'>
                                            ...
                                            <input type='hidden' name='alterar-gerente-id' value='" . $login->getId() . "'/>
                                            <input type='hidden' name='alterar-gerente-id-usuario' value='" . $usr->getId() . "'/>
